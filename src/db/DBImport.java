...
public class DBImport {
		...
		try {
	   		 ...
	   		 try {
	   			 ...
	   			 conn = (Connection) DriverManager
	   					 .getConnection("jdbc:mysql://localhost:3306/laiproject?"
	  		...
	  		//Step 2: create tables
	   		 ...
	   		 BufferedReader reader = new BufferedReader(new FileReader(
	   				 "src/dataset/yelp_academic_dataset_business.json"));
	...
	/**
	  ...
	  */
	  ...
	  /**
	  * Convert a JSONArray to comma separated String
	  */
	  ...
	  /**
	  * Convert a comma separated String to JSONArray
	  * "1111","2222","3333"
	  */
